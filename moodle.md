...
**Информационная (навигационная) панель** — это элемент интерфейса, содержащий ссылки и инструменты. Может включать ссылки на курсы, уведомления, отчёты, профиль пользователя и другие часто используемые разделы системы. [Подробнее][lms]
...
**Элемент (item)** — в официальной документации этот термин не рассматривается как отдельное ключевое понятие, но иногда используется для описания различных составляющих учебного контента и курса. Moodle в основном строится из трёх категорий элементов для учебного процесса:
  ...
  - Активности (Activities) — это общий термин для учебных действий или задач, которые студенты могут выполнять в курсе. Например, тесты, форумы, чаты и задания — всё это активности. Термин *"активность"* описывает интерактивные элементы, которые преподаватель добавляет для вовлечения студентов.
    > Модули активности — более техническое обозначение, используемое в настройках и документации Moodle, чтобы подчеркнуть, что каждая активность является отдельным модулем или плагином, интегрированным в систему. Например, "mod_quiz" (модуль теста)
  - Ресурсы (Resources)
  - Блоки (Blocks)
...
<!-- TODO: Перевод -->
- **Задание (Assignment)**: используется для создания заданий, которые студенты могут выполнять и загружать в Moodle.
